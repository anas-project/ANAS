  ...
  class NextcloudRunner < BaseRunner
    ...
    def cal_envs(envs)
      ...
      if new_envs['NEXTCLOUD_DB_TYPE'] == 'mariadb'
        new_envs['NEXTCLOUD_NETWORK_DB'] = new_envs['MARIADB_NETWORK_NAME']
      elsif new_envs['NEXTCLOUD_DB_TYPE'] == 'postgres'
        new_envs['NEXTCLOUD_NETWORK_DB'] = new_envs['POSTGRES_NETWORK_NAME']
      end
      ...
      new_envs['SMAL_SP__NEXTCLOUD__DOMAIN'] = new_envs['NEXTCLOUD_DOMAIN']
    ...
    def self.dependent_mods(base_envs)
      return ['traefik', 'eturnal'] # TODO change to service
    end
