  ...
  class LlngRunner < BaseRunner
    ...
    def cal_envs(envs)
      ...
      if new_envs['LLNG_DB_TYPE'] == 'mariadb'
        new_envs['LLNG_NETWORK_DB'] = new_envs['MARIADB_NETWORK_NAME']
      elsif new_envs['LLNG_DB_TYPE'] == 'postgres'
        new_envs['LLNG_NETWORK_DB'] = new_envs['POSTGRES_NETWORK_NAME']
      end
      ...
      new_envs['LLNG_OIDC_CONFIGURATION_ENDPOINT'] = "#{new_envs['LLNG_DOMAIN_FULL']}/.well-known/openid-configuration"
