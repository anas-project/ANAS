...
> [backup.go](../../internal/runner/backup.go)、
> [backup_create.go](../../internal/runner/backup_create.go)、
> [backup_transfer.go](../../internal/runner/backup_transfer.go)、
> [backup_txn.go](../../internal/runner/backup_txn.go)、
> [backup_restore.go](../../internal/runner/backup_restore.go)、
> [backup_cli.go](../../internal/runner/backup_cli.go)。
...
[workspace-backup-plan.md](../workspace-backup-plan.md) §7 已经论证过的那一条，此处
只是它在读取方向上的另一次体现。
