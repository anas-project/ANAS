...
One top-level switch enables the complete mirror set:
...
[mainland mirror and CNB distribution design](research/china-mainland-mirrors-and-cnb-distribution-2026-08-11.md)
...
the module source tree. It does still pull base images from a registry.
