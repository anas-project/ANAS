...
| [Forgejo Module 设计](/architecture/forgejo-module-design) §4 | Incus 控制面归属改为 `incus` Module | 未开始 |
| [Forgejo Module 实施计划](/plans/forgejo-module) M2 | 只保留“作为消费者接入”，Provider 工作引用本计划 | 未开始 |
