...
验收依据是[Changelog 要求](/requirements/changelog)的需求矩阵；写作规则与机制细节见[Changelog 规范](/developer/changelog-standard)。
...
- [ ] 在[Changelog 规范](/developer/changelog-standard)中固化分节顺序与条目写法。
