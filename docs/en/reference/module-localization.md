...
| --- | --- | --- | --- | --- | --- | --- | ---: |
| [authentik](#authentik) | 2026.5.6-r7 | container | supported | browser | not_consumed | not_consumed | 17 |
| [collabora](#collabora) | 26.4.2-r3 | container | supported | integration | not_consumed | not_consumed | 43 |
| [ddns_go](#ddns_go) | 6.17.4-r4 | container | supported | application | not_consumed | not_consumed | 2 |
| [ddns_updater](#ddns_updater) | 2.10.0-r2 | application | fixed | fixed | not_consumed | not_consumed | 1 |
| [eturnal](#eturnal) | 1.12.2-r4 | container | not_applicable | none | not_applicable | not_applicable | 0 |
| [freeradius](#freeradius) | 3.2.10-r2 | container | not_applicable | none | not_applicable | not_applicable | 0 |
| [lam](#lam) | 9.6.0-r6 | application | supported | deployment_default | applied | not_consumed | 15 |
| [lego](#lego) | 5.3.1-r3 | container | not_applicable | none | not_applicable | not_applicable | 0 |
| [llng](#llng) | 2.23.2-r8 | container | supported | browser | not_consumed | not_consumed | 17 |
| [mariadb](#mariadb) | 12.3.2-r2 | container | supported | browser | not_consumed | not_consumed | 47 |
| [meshcentral](#meshcentral) | 1.2.4-r5 | container | supported | browser | not_consumed | not_consumed | 30 |
| [netbird](#netbird) | 0.76.1-r3 | partial | fixed | fixed | not_consumed | not_consumed | 1 |
| [nextcloud](#nextcloud) | 34.0.2-r6 | partial | supported | browser | fallback | fallback | 58 |
| [oauth2_proxy](#oauth2_proxy) | 7.15.3-r2 | container | fixed | fixed | not_consumed | not_consumed | 1 |
| [postgres](#postgres) | 18.4.0-r2 | container | supported | browser | not_consumed | not_consumed | 47 |
| [samba_dc](#samba_dc) | 4.23.6-r6 | system | not_applicable | none | not_applicable | not_applicable | 0 |
| [samba_fs](#samba_fs) | 4.23.6-r4 | container | not_applicable | client | not_applicable | not_applicable | 0 |
| [traefik](#traefik) | 3.7.10-r3 | container | fixed | fixed | not_consumed | not_consumed | 1 |

## authentik

- **Version / 版本：** `2026.5.6-r7`; reviewed 2026-08-13
...
- **Version / 版本：** `26.4.2-r3`; reviewed 2026-08-13
...
- **Version / 版本：** `6.17.4-r4`; reviewed 2026-08-13
...
- **Version / 版本：** `2.10.0-r2`; reviewed 2026-08-13
...
- **Version / 版本：** `1.12.2-r4`; reviewed 2026-08-17
...
- **Version / 版本：** `3.2.10-r2`; reviewed 2026-08-13
...
- **Version / 版本：** `9.6.0-r6`; reviewed 2026-08-13
...
- **Version / 版本：** `5.3.1-r3`; reviewed 2026-08-13
...
- **Version / 版本：** `2.23.2-r8`; reviewed 2026-08-17
...
- **Version / 版本：** `12.3.2-r2`; reviewed 2026-08-13
...
- **Version / 版本：** `1.2.4-r5`; reviewed 2026-08-13
...
- **Version / 版本：** `0.76.1-r3`; reviewed 2026-08-13
...
- **Version / 版本：** `34.0.2-r6`; reviewed 2026-08-13
...
- **Version / 版本：** `7.15.3-r2`; reviewed 2026-08-13
...
- **Version / 版本：** `18.4.0-r2`; reviewed 2026-08-13
...
- **Version / 版本：** `3.7.10-r3`; reviewed 2026-08-13
