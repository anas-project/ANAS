...
As of 2026-08-21, the built-in release gate fixes a baseline of 20 Modules,
151 parameters, `unknown=0`, two `input_required` entries, 23 final
must-resolve entries, and the exact 15 declared constraints. Tests also prove
