...
Read [repository layout](repository-layout.md), [module development](module-development.md), [testing](testing.md), [container image releases](release.md), and the [architecture overview](/en/architecture/). The detailed Chinese design documents remain normative while English translations are completed.
