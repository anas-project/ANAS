...
[`internal/dns/providers.yml`](https://github.com/anas-project/ANAS/blob/master/internal/dns/providers.yml) 是唯一的真相源。
...
[`cmd/gen-dns-registry`](https://github.com/anas-project/ANAS/blob/master/cmd/gen-dns-registry/main.go) 把每个 engine 的切片投影
...
（[`internal/runner/dnscred.go`](https://github.com/anas-project/ANAS/blob/master/internal/runner/dnscred.go)）：
...
（[`resolveOrder`](https://github.com/anas-project/ANAS/blob/master/internal/runner/runner.go)）。
...
[Traefik Module README](https://github.com/anas-project/ANAS/blob/master/modules/traefik/README.md)）：
...
[`anas-ddns-go-reconcile`](https://github.com/anas-project/ANAS/blob/master/modules/ddns_go/ddns-go/reconcile/) 合并。
