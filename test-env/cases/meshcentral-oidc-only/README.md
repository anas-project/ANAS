...
> 需求来源：[`meshcentral-oidc-only.md`](../../../modules/meshcentral/dev-docs/requirements/meshcentral-oidc-only.md)
>
> 实施计划：[`meshcentral-oidc-only.md`](../../../modules/meshcentral/dev-docs/plans/archived/meshcentral-oidc-only.md)
