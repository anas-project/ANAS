...
const entryIP = process.env.ANAS_TEST_ENTRY_IP || "10.252.0.2";

export default defineConfig({
  testDir: ".",
  testMatch: "iam-logout.spec.mjs",
  ...
  outputDir: process.env.ANAS_TEST_PLAYWRIGHT_OUTPUT || "/private/tmp/anas-iam-playwright",
});
