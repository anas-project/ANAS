...
export default defineConfig({
  testDir: ".",
  testMatch: "vikunja-authentik-matrix-browser.spec.mjs",
  ...
  outputDir: process.env.ANAS_TEST_PLAYWRIGHT_OUTPUT || "/private/tmp/anas-vikunja-authentik-matrix-playwright",
});
