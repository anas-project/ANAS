...
export default defineConfig({
  testDir: ".",
  testMatch: "vikunja-load-browser.spec.mjs",
  timeout: Number(process.env.ANAS_TEST_BROWSER_TIMEOUT || 240_000),
  ...
  outputDir: process.env.ANAS_TEST_PLAYWRIGHT_OUTPUT || "/private/tmp/anas-vikunja-load-browser-playwright",
});
