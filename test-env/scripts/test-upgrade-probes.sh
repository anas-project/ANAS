...

{
  ...
  for cask in core lego bind samba_dc samba_fs traefik keycloak llng mariadb postgres eturnal nextcloud collabora meshcentral netbird lam ddns freeradius; do
    current=$(awk '
