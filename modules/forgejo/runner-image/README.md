...
The repository assets and unit tests do not replace the external image build and real Incus/KVM isolation E2E. Those remain release gates in `modules/forgejo/dev-docs/plans/forgejo-module.md`.
