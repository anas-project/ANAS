...
> Status: current implementation; based on `0.76.1-r2` / `anas.module/v1`.
...
| `anas_management` | `${ANAS_IMAGE_REGISTRY:-ghcr.io/anas-project}/anas-netbird-management:0.76.1-r2` | `traefik` | 2 |
