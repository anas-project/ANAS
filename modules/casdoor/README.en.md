...
> [!WARNING]
> Lifecycle is `developing` and intended only for development and validation. Permanent directory anchors, per-application group authorization, and deactivation propagation have real OIDC/SAML E2E acceptance; client-session revocation, recovery, and release lifecycle acceptance remain incomplete.
