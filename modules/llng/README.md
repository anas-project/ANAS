...
LLNG Manager 当前使用 LLNG Portal 的 AD 认证和 Samba `Admins` 组授权。旧的
...
access to the Samba `Admins` group. The removed `LLNG_PASSWORD` variable had no
...
- Module version / 版本：`2.23.2-r3`（reviewed 2026-08-13）
