...
// envPrefix is this module's environment namespace. The runner materialises DNS
...
//
// The runner owns one generated local credential per module and injects it only
...
// key namespaces a parameter under this module's env prefix.
