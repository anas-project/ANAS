...
// slug is the authentik application slug. Cask names are already lowercase
...
// ensureSigningKeypair provisions the SAML signing material this cask installs
...
// authentik blueprint. No application cask ever writes an authentik-shaped
...
func renderClientBlueprint(e map[string]string) (string, error) {
	...
	b.WriteString("# Auto-generated by the anas authentik cask. Do not edit.\n")
