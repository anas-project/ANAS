...
6. 在 [Module IAM / OIDC 支持清单](../../docs/reference/module-iam-support.md)中更新当前状态。
...
Casdoor `3.143.0`；Consumer 版本与 endpoint 以[支持清单](../../docs/reference/module-iam-support.md#固定版本登出矩阵)
