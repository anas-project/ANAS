...
6. 同一 PR 修改 [CLI 契约索引](../../docs/reference/contracts/index.md)中“面向……将来的 web 服务”那句话（要求文档 §1.3）。
...
| 项 | 状态 |
| --- | --- |
| [管理员账户体系](../../docs/architecture/admin-account-system.md)补充 `Admins` 扩大范围说明 | 已完成（2026-08-21） |
| [CLI 契约索引](../../docs/reference/contracts/index.md)措辞修正（R-006） | 未开始，随第一条切片一起做 |
