...
[`app-catalog-design.md`](../../docs/architecture/app-catalog-design.md) 为唯一规范来源，本文不另建一套
平行 schema。
...
[`app-catalog-design.md`](../../docs/architecture/app-catalog-design.md)。
...
[`app-catalog-design.md`](../../docs/architecture/app-catalog-design.md) 的设计阶段。
...
[`app-catalog-design.md`](../../docs/architecture/app-catalog-design.md) 为准。
